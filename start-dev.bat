...
start "Backend Server" cmd /k "cd backend && call venv\Scripts\activate.bat 2>nul || echo Virtual env not found. Proceeding with global python... && pip install -r requirements.txt && uvicorn main:app --reload --port 8005"
